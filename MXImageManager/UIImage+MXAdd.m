...
- (void)mx_drawInRect:(CGRect)rect
      withContentMode:(UIViewContentMode)contentMode
        clipsToBounds:(BOOL)clips {
    CGRect drawRect = MXYYCGRectFitWithContentMode(rect, self.size, contentMode);
...
CGRect MXYYCGRectFitWithContentMode(CGRect rect, CGSize size, UIViewContentMode mode) {
